...
export class createUserTransactions1601164799463 implements MigrationInterface {
    name = 'createUserTransactions1601164799463'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "users_transactions" ("id" SERIAL NOT NULL, "value" integer NOT NULL, "user_id" integer, "typeTransaction_id" integer, CONSTRAINT "PK_fb9a1da696b17ab6c3ce75b6c7f" PRIMARY KEY ("id"))`);
